 ...
 * @template {unknown} P
 * @typedef {Match<P, [
 *     (p: Mut<Readonly<unknown>>) => 'Array of Mut',
 *     (p: Number) => 'Number',
 ...
 * @typedef {TestMatch1<Boolean>} MatchTestCase1_ShouldBe_Boolean // failed
 ...
 * @typedef {TestMatch4<Boolean>} MatchTestCase6_ShouldBe_Boolean_When_True // failed
 ...
 * @typedef {TestMatch8<Mut<(a: String) => Boolean>>} MatchTestCase26_ShouldBe_Void
 * @typedef {TestMatch8<Mut<[(a: String) => Boolean]>>} MatchTestCase27_ShouldBe_Void
